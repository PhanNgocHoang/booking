            ...
            <div>
                <div className="container-fluid border rounded-0 border-dark">
                    <div className="row align-items-center" style={{ backgroundColor: '#ffffff', overflow: 'hidden', position: 'fixed', top: 0, zIndex: 10, width: '100%', height: 102 }}>
                        <div className="col-sm-6 col-md-6 text-center d-xl-flex justify-content-xl-start align-items-xl-center" style={{ height: 112 }}>
                            <Link to={"/"}>
                                <img src="assets/img/1561179296437-Black%20Logo%20Mark.png" style={{ width: '3.0rem' }} />
                            </Link>
                                ...
                                <div className="container"><button data-toggle="collapse" className="navbar-toggler" data-target="#navcol-1"><span className="sr-only">Toggle navigation</span><span className="navbar-toggler-icon" /></button>
                                    <div className="collapse navbar-collapse" id="navcol-1">
                                        <ul className="nav navbar-nav ml-auto">
                                            <Link to={"/host"}>
                                                <li className="nav-item" role="presentation" className="nav-link" >Host</li>
                                            </Link>
                                            <Link to={"/register"}>
                                                <li className="nav-item" role="presentation" className="nav-link" >Đăng ký</li>
                                            </Link>
                                            <Link to={"/login"}>
                                                <li className="nav-item" role="presentation" className="nav-link" >Đăng nhập</li>
                                            </Link>
                                            <li className="nav-item dropdown"><a className="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" >VN</a>
                                                <div className="dropdown-menu" role="menu"><a className="dropdown-item" role="presentation">Tiếng Anh</a><a className="dropdown-item" role="presentation" href="#">Tiếng Nhật</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
